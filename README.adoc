...
Note: Information related to the artifacts created with this action will be published to CloudBees Platform. This action also reports artifact related data to the workflow run for artifact traceability purposes.
== Inputs
